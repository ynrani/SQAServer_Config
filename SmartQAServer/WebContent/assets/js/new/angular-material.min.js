                            ...
                            if (r && r.length) {
                                ...
                                r.length && t.forEach(r, function(e) {
                                    ...
                                    var n = e[0].getAttribute(d),
                                        r = n && E.validateScope(e) ? e.scope().$eval(n) !== !1 : !0;
                                    r && (o = e)
                                })
                            }
                            return o
            ...
            if (r && 0 !== i.length) {
                ...
                $.forEach(function(e) {
                    ...
                    for (var t, n = (e.match(c), 0); t = $[n]; n++)
                        if (e.indexOf(".md-" + t) > -1) return k[t] += e;
                    for (n = 0; t = $[n]; n++)
                        if (e.indexOf(t) > -1) return k[t] += e;
                    return k[y] += e
    ...
    function() {
        ...
        function o(e) {
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                ...
                function M(e, n) {
                    var d = "alert" === n.$type ? "alertdialog" : "dialog",
                        c = e.find("md-dialog-content"),
                        s = e.attr("id") || "dialog_" + r.nextUid();
                    e.attr({
                        role: d,
                        tabIndex: "-1"
        ...
        function a(e) {
            function o(e, o, c, s, l, m, u, p, h) {
                ...
                function g(r, i, a) {
                    ...
                    function f() {
                        return l(function(e) {
                            ...
                            t.container.element.css(M.toCss(t.container.styles)), t.dropDown.element.css(M.toCss(t.dropDown.styles)), m(function() {
                                i.addClass("md-active"), t.dropDown.element.css(M.toCss({
                                    transform: ""
                                })), b(a.focusedNode), e()
                            })
                        })
                    ...
                    function g(e, t, n) {
                        return n.disableParentScroll && !c.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = c.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = c.createBackdrop(e, "md-select-backdrop md-click-catcher"), p.enter(n.backdrop, h[0].body, null, {
                                duration: 0
                            })),
                            function() {
                ...
                function E(e, n, o) {
                    ...
                    var L = m.getBoundingClientRect(),
                        P = Math.round(100 * Math.min(E.width / N.width, 1)) / 100,
                        F = Math.round(100 * Math.min(E.height / N.height, 1)) / 100;
                    return {
                        container: {
                            element: t.element(m),
                            styles: {
        ...
        function e(e, n, o, r, i, a, d, c, s) {
            ...
            function m(o, l, m, u) {
                ...
                var F = t.element(l[0].querySelector(".md-thumb")),
                    ...
                    U = F.parent(),
                    z = t.element(l[0].querySelector(".md-track-container")),
                    q = t.element(l[0].querySelector(".md-track-fill")),
