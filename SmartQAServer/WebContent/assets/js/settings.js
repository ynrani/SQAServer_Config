...
var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active"  data-theme="assets/css/theme-default.css"><img src="assets/img/themes/defNw.jpg"/></a>'            
            +'<a href="#" data-theme="assets/css/theme-red.css"><img src="assets/img/themes/redn.jpg"/></a>'                        
...
$(document).ready(function(){
	...
	fileref.setAttribute("href", filename1)
...
$(".ts-themes a").click(function(){
	...
	filename=this.dataset.theme;
	document.cookie="theme="+filename;
	var fileref = document.createElement("link")
	fileref.setAttribute("rel", "stylesheet")
	fileref.setAttribute("type", "text/css")
...
// $('link[rel=stylesheet][href~="filename"]').remove();  //remove css
});
/* END Change Theme */
