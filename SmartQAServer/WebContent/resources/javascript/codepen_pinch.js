...
$( document ).ready(function(){
    ...
    //code start
    var cooloff = 200;
    var gestureControl = _.debounce(function(gesture) {
	    ...
	    console.log(swipeDirection);
		     ...
		     if(clockwise)
		        ...
		        console.log('Clockwise Circle !!');
		        plus();
		        }
		      else
		        {
		        console.log('Anti-Clockwise Circle !!');
		        minus();
		    }
...
/*		else if(gesture.type == 'keyTap'){
	...
	//Zoom in and zoom out functionality for radial tree
